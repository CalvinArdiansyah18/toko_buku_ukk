      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          <div class="box-header">
            <a href="index.php?page=tambah_pasok" class="btn btn-primary" role="button" title="Tambah Data"><i
          ...
          <div class="box-body table-responsive">
            <table id="pasok" class="table table-bordered table-hover">
              ...
              <tbody>
                <?php
                include "../toko_buku_ukk/conf/conn.php";
                $no = 0;
                ...
                while ($row = mysqli_fetch_array($query)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="index.php?page=ubah_pasok&id=<?= $row['id_pasok']; ?>" class="btn btn-success"
                      ...
                      <a href="javascript:void(0);" class="btn btn-danger" role="button" title="Hapus Data"
                        onclick="hapusPasok(<?= $row['id_pasok']; ?>);"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
                  </tr>
